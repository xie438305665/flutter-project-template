...
class ChannelHandler(private val activityHelper: ActivityHelper
    ...
    fun iosScan(call: MethodCall, result: MethodChannel.Result) {
        ...
        activityHelper.showIosScannerActivity(result, config)
    }


    @Keep
    @Suppress("unused", "UNUSED_PARAMETER")
    fun androidScan(call: MethodCall, result: MethodChannel.Result) {
        activityHelper.showAndroidScannerActivity(result)
    }
